...
import { getOfferedPackagesReferrel } from "store/offered-tests/actions";
...
{this.props.match.params.filnalurl && this.props.match.params.guest_id ? (
        ...
        <div className="page-content">
          <MetaTags>
            <title>Package Offered | Lab Hazir</title>
          </MetaTags>
          <Container fluid>
            {/* <Breadcrumbs title="Nearby Labs" breadcrumbItem="Packages Offered" /> */}
            <h4>Packages Offered by {lab_name}</h4>
            {this.state.success ? (
...
const mapDispatchToProps = (dispatch, ownProps) => ({
  ongetOfferedTestsReferrel: () =>
    dispatch(getOfferedPackagesReferrel(ownProps.match.params.lab_account_id)),
