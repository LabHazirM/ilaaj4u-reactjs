...
class NearbyLabs extends Component {
  constructor(props) {
    ...
    console.log("yaha ani chahi hai uuid", this.props.match.params.id, this.props.match.params.guest_id, this.state.user_id, this.props.match.params.filnalurl)
  ...
  componentDidMount() {
    ...
    if (latitudeFromUrl && longitudeFromUrl) {
      ...
      if (navigator.geolocation) {
        ...
        //   corporatepatient: this.props.match.params.id,
        // };
  ...
  */
  ...
  render() {
    ...
    // const { patientProfile } = this.props;
    // console.log("there is patient profile and yes and not", this.props.patientProfile, this.props.match.params.id)
                      ...
                      onClick={() =>
                        ...
                        history.push(
                          this.props.match.params.uuid
                            ...
                            : `/${nearbyLab.account_id}/offered-test-by-lab-corporate/${this.props.match.params.guest_id}`
                        )
                      } style={{ height: "95%" }}
                    >
                      <CardBody>
                  ...
                  <Col xl="4" sm="6" key={"_col_" + key}>
                    <Card
                      onClick={() =>
                        history.push(
                          this.state.user_id
                            ? `/nearby-lab-detail/${nearbyLab.account_id}/${this.state.user_id}/${this.props.match.params.uuid}`
                            : `/nearby-lab-detail/${nearbyLab.account_id}`
                        )
                      } style={{ height: "95%" }}
                    >
