...
export const GET_MARKETERS_LIST = "GET_MARKETERS_LIST";
export const GET_MARKETERS_LIST_SUCCESS = "GET_MARKETERS_LIST_SUCCESS";
export const GET_MARKETERS_LIST_FAIL = "GET_MARKETERS_LIST_FAIL";
