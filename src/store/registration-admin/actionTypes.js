...
// -------------------- DOCTOR ACTION TYPES --------------------
export const GET_PENDING_DOCTORS = "GET_PENDING_DOCTORS";
export const GET_PENDING_DOCTORS_SUCCESS = "GET_PENDING_DOCTORS_SUCCESS";
export const GET_PENDING_DOCTORS_FAIL = "GET_PENDING_DOCTORS_FAIL";

export const GET_APPROVED_DOCTORS = "GET_APPROVED_DOCTORS";
export const GET_APPROVED_DOCTORS_SUCCESS = "GET_APPROVED_DOCTORS_SUCCESS";
export const GET_APPROVED_DOCTORS_FAIL = "GET_APPROVED_DOCTORS_FAIL";

export const GET_UNAPPROVED_DOCTORS = "GET_UNAPPROVED_DOCTORS";
export const GET_UNAPPROVED_DOCTORS_SUCCESS = "GET_UNAPPROVED_DOCTORS_SUCCESS";
export const GET_UNAPPROVED_DOCTORS_FAIL = "GET_UNAPPROVED_DOCTORS_FAIL";

export const APPROVE_UNAPPROVE_DOCTOR = "APPROVE_UNAPPROVE_DOCTOR";
export const APPROVE_UNAPPROVE_DOCTOR_SUCCESS =
  "APPROVE_UNAPPROVE_DOCTOR_SUCCESS";
export const APPROVE_UNAPPROVE_DOCTOR_FAIL = "APPROVE_UNAPPROVE_DOCTOR_FAIL";